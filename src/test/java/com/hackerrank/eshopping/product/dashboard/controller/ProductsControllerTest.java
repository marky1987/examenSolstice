...
public class ProductsControllerTest {
    ...
    /**
     * @throws Exception It tests updating retail price and availability of a product
     */
    @Test
    @Order(7)
    ...
    /**
     * @throws Exception It tests updating discount price and availability of a product
     */
    @Test
    @Order(8)
    ...
    /**
     * @throws Exception It tests updating retail price, discount price and availability of a product
     */
    @Test
    @Order(9)
    ...
    /**
     * @throws Exception It tests finding a product with a given category and availability
     */
    @Test
    @Order(15)
